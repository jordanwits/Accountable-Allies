      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-10 min-h-[100svh] flex flex-col justify-start md:justify-center pt-28 pb-16 md:pt-0 md:pb-0">
        ...
        <div className="grid md:grid-cols-12 gap-8 md:gap-12 items-end">
          ...
          <div className="md:col-span-8">
            <p
              className="font-display italic-fraunces text-cream-50/80 text-2xl md:text-3xl animate-fade-up"
            ...
            >
              I've done life{' '}
              <span className="italic-fraunces text-ochre-400">the hard way</span>
              , which is exactly why your books{' '}
                <span className="relative whitespace-nowrap">
                  don't have to be.
                  <svg
                    aria-hidden="true"
                    viewBox="0 0 480 18"
                    className="absolute left-0 right-0 -bottom-3 w-full h-3 text-ochre-400"
                    preserveAspectRatio="none"
                  >
                    <path
                      d="M2,12 Q120,2 240,8 T478,7"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2.5"
                      strokeLinecap="round"
